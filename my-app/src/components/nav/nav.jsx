...
const Navbar = () => {
  return (
    <nav className={s.nav}>
      <div>
        <a href="https://github.com/Valentin-Sp/my-first-repo" className={s.item}>Profile</a>
      </div>
      <div>
        <a href="https://github.com/Valentin-Sp/my-first-repo" className={s.item}>Massages</a>
      </div>
      <div>
